...
namespace ProjetoFinal.Controllers
{
    public class EstadoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EstadoId,EstadoNome,PaisId")] Estado estado)
        {
            ...
            ViewData["PaisId"] = new SelectList(_context.Pais, "PaisId", "PaisId", estado.PaisId);
            return View(estado);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstadoId,EstadoNome,PaisId")] Estado estado)
        {
