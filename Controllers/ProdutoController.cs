...
namespace ProjetoFinal.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,ProdutoName,ProdutoEstoque,FornecedorId,TipoProdutoId")] Produto produto)
        {
            ...
            ViewData["TipoProdutoId"] = new SelectList(_context.TipoProduto, "TipoProdutoId", "TipoProdutoId", produto.TipoProdutoId);
            return View(produto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,ProdutoName,ProdutoEstoque,FornecedorId,TipoProdutoId")] Produto produto)
        {
