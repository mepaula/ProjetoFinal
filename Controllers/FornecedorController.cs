...
namespace ProjetoFinal.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,FornecedorName,FornecedorEmail")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FornecedorId,FornecedorName,FornecedorEmail")] Fornecedor fornecedor)
        {
