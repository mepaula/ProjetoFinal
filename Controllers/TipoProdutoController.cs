...
namespace ProjetoFinal.Controllers
{
    public class TipoProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TipoProdutoId,TipoProdutoDescricao")] TipoProduto tipoProduto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoProdutoId,TipoProdutoDescricao")] TipoProduto tipoProduto)
        {
